...
def main():
    ...
    train_dataloader_cifar = DataLoader(train_dataset_cifar, batch_size=1, shuffle=True, num_workers=2)
    test_dataloader_cifar = DataLoader(test_dataset_cifar, batch_size=1, shuffle=True, num_workers=2)
